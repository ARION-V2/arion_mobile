...
class DetailRiwayatPage extends StatefulWidget {
  ...
  const DetailRiwayatPage({Key? key, required this.delivery}) : super(key: key);
...
class _DetailRiwayatPageState extends State<DetailRiwayatPage> {
  ...
  void initState() {
    ...
    kGooglePlex = CameraPosition(
      target: LatLng(double.parse(widget.delivery.partner!.latitude!),
          double.parse(widget.delivery.partner!.longitude!)),
      zoom: 16,
    );
  }
  @override
  Widget build(BuildContext context) {
    return GeneralPage(
      ...
      titleAppBar: const Text("Detail Riwayat Pengantaran"),
      body: Stack(
        children: [
          ListView(
            ...
            children: [
              ...
              Column(
                children: [
                  ItemPengantaranWidget(delivey: widget.delivery),
                  // GestureDetector(
                  //   onTap: () {
                  //     Get.to(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      CardCourierWidget(
                        courier: widget.delivery.courier!,
                        onTap: () {},
                      ),
                    ],
                  ),
                              ...
                              children: List.generate(
                                ...
                                (index) => Container(
                                  ...
                                  child: ProductCardDeliveryWidget(
                                      productDelivery:
                                          widget.delivery.products![index]),
                                ),
                              ),
                            ),
                          ),
