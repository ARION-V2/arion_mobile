...
const Color mainColor = Color.fromARGB(255, 214, 27, 13);
const Color IconColor = Color(0xFF2C3466);
...
const Color greyColor2 = Color(0xFFEFECEC);

 Color accentColor1 = mainColor.withOpacity(0.2);
const Color accentColor2 = Color(0xFFFFB800);
const Color accentColor3 = Color(0xFFFF860D);
Color accentColor4 = Colors.grey[400]!;

const Color blue2 = Color.fromARGB(255, 203, 225, 255);
const Color blue1 = Color.fromARGB(255, 26, 122, 255);
